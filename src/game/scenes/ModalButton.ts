...
export class ModalButton extends Phaser.GameObjects.Container{
  ...
  destroy(fromScene?:boolean):void{this.scene.input.keyboard?.off("keydown",this.onKey,this);super.destroy(fromScene);}
}

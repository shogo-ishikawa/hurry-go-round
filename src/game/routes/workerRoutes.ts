...
export const WORKER_ROUTES = {
 home:FARM_LAYOUT.workerHome, fieldEntry:FARM_LAYOUT.wheatField.entry, crate:{x:FARM_LAYOUT.wheatCrate.x,y:FARM_LAYOUT.wheatCrate.y}, crateWait:FARM_LAYOUT.wheatCrate.wait,barn:FARM_LAYOUT.barn,

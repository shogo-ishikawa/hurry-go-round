...
export function createPersistedSnapshot(state: GameState, runtime: RuntimeSnapshot): PersistedGameSnapshot {
  return {
    ...
    workers: { harvestWorker: { hired: state.workers.harvestWorker.hired, carried: state.workers.harvestWorker.carried }, transportWorker: { hired: state.workers.transportWorker.hired, carried: state.workers.transportWorker.carried }, cornHarvestWorker: { hired: state.workers.cornHarvestWorker.hired, carried: state.workers.cornHarvestWorker.carried }, cornTransportWorker: { hired: state.workers.cornTransportWorker.hired, carried: state.workers.cornTransportWorker.carried }, poultryCaretaker: { hired: state.workers.poultryCaretaker.hired, resource: state.workers.poultryCaretaker.resource, carried: state.workers.poultryCaretaker.carried } },

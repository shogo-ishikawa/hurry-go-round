...
明るい農場を走り回り、生産から販売までの循環を育てるブラウザーゲームです。**v0.6.0 — Mixed Cargo, Visual Polish & Expanded Automation** は、v0.4.0 の麦・市場・従業員ループを保ったまま、土地購入、とうもろこし、鶏とたまごを追加します。
...
牛・豚・羊、乳・肉・羊毛、繁殖・病気・寿命・個体差、複数鶏小屋、加工品・パン・料理・レシピ、季節・天候・灌漑・農薬・肥料・土壌品質、セーブ、IndexedDB、localStorage、PWA、オフライン進行、音楽・効果音、アカウント、クラウド同期、ランキング、課金・広告、外部API、マルチプレイはv0.6.0の対象外です。
